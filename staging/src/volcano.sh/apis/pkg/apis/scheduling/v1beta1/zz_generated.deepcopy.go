...
func (in *PodGroupAffinityTerm) DeepCopyInto(out *PodGroupAffinityTerm) {
	*out = *in
	if in.PodGroupSelector != nil {
		in, out := &in.PodGroupSelector, &out.PodGroupSelector
...
func (in *TopologyAffinitySpec) DeepCopy() *TopologyAffinitySpec {
	if in == nil {
		return nil
	}
	out := new(TopologyAffinitySpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PodGroupSpec) DeepCopyInto(out *PodGroupSpec) {
	*out = *in
	...
	if in.TopologyAffinity != nil {
		in, out := &in.TopologyAffinity, &out.TopologyAffinity
		*out = new(TopologyAffinitySpec)
		(*in).DeepCopyInto(*out)
	}
	return
